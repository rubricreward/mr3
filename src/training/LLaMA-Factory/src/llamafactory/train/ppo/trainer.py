...
class CustomPPOTrainer(PPOTrainer, Trainer):
    ...
    def get_rewards(
        ...
        elif self.finetuning_args.reward_model_type == "rmr1":
            queries_decoded = self.processing_class.batch_decode(queries, skip_special_tokens=False)
            responses_decoded = self.processing_class.batch_decode(responses, skip_special_tokens=False)
            return self.reward_model.evaluate(queries_decoded, responses_decoded)
